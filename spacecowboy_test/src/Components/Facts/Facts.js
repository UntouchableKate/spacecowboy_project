      ...
      <ul className="fact-section__list">
        <li className="fact-section__item">
          ...
          <p className="fact-section__item-text">
            You might have guessed that from our company name, but the fact is:
            Yes, we are indeed cowboys. Cowboys who'd like to go to space. Deal
            with it.
          </p>
        </li>
        <li className="fact-section__item">
          <div className="fact-section__circle">
            <img className="fact-section__icon" src={instrumentsIcon} alt="icon"/>
          </div>
          <p className="fact-section__item-title">we like to tinker</p>
          <p className="fact-section__item-text">
            There are a lot of things lying around on a typical Cowboy Ranch. So
            we started putting them together, and got really good at rocket
            building.
          </p>
        </li>
        <li className="fact-section__item">
          ...
          <p className="fact-section__item-text">
            Once we got our first proper rocket, everything went quite fast. And
            now we are the #1 independent space agency in the world. Who would
            have guessed?
          </p>
        </li>
      </ul>
